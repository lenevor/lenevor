<footer>
	...
	<div class="info">
		...
		<div class="name">
			...
			<span class="benchmark-memory" title="Benchmark: Memory usage">
				<svg id="chipset" xmlns="http://www.w3.org/2000/svg" xml:space="preserve" viewBox="0 0 512 512" version="1.1" style="shape-rendering:geometricPrecision; text-rendering:geometricPrecision; image-rendering:optimizeQuality; fill-rule:evenodd; clip-rule:evenodd" xmlns:xlink="http://www.w3.org/1999/xlink">
					<g id="Layer_x0020_1">
						...
						<rect x="83" y="82" width="334" height="335" rx="26" ry="26"/>
						<rect x="111" y="111" width="277" height="278" rx="10" ry="10"/>
						<path d="M122 111l256 0c6,0 11,5 11,10l0 39c-38,64 -130,107 -186,107 -56,0 -64,-8 -92,-21l0 -125c0,-5 5,-10 11,-10z"/>
						<path d="M152 288l0 8 -15 0 0 -8 15 0zm114 0l-12 0 0 8 12 0 0 -8zm-20 0l0 8 -15 0 0 -8 15 0zm-23 0l0 8 -16 0 0 -8 16 0zm-24 0l0 8 -15 0 0 -8 15 0zm-23 0l0 8 -16 0 0 -8 16 0zm48 34l0 -8 78 0 0 8 -78 0zm-86 0l0 -8 78 0 0 8 -78 0zm38 18l0 8 -39 0 0 -8 39 0zm141 0l0 8 -8 0 0 -8 8 0zm-31 0l0 8 -40 0 0 -8 40 0zm-63 0l0 8 -8 0 0 -8 8 0zm-16 0l0 8 -8 0 0 -8 8 0z"/>
						<circle cx="159" cy="161" r="17"/>
