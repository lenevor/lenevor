...
return [
    ...
    'Syscode\\Core\\Exceptions\\AccessDeniedHttpException' => SYS_PATH.'classes/Core/Exceptions/AccessDeniedHttpException.php',
    'Syscode\\Core\\Exceptions\\BadRequestHttpException' => SYS_PATH.'classes/Core/Exceptions/BadRequestHttpException.php',
    'Syscode\\Core\\Exceptions\\ConflictHttpException' => SYS_PATH.'classes/Core/Exceptions/ConflictHttpException.php',
    'Syscode\\Core\\Exceptions\\GoneHttpException' => SYS_PATH.'classes/Core/Exceptions/GoneHttpException.php',
    'Syscode\\Core\\Exceptions\\HttpException' => SYS_PATH.'classes/Core/Exceptions/HttpException.php',
    'Syscode\\Core\\Exceptions\\LenevorException' => SYS_PATH.'classes/Core/Exceptions/LenevorException.php',
    'Syscode\\Core\\Exceptions\\LengthRequiredException' => SYS_PATH.'classes/Core/Exceptions/LengthRequiredException.php',
    'Syscode\\Core\\Exceptions\\MethodNotAllowedHttpException' => SYS_PATH.'classes/Core/Exceptions/MethodNotAllowedHttpException.php',
    'Syscode\\Core\\Exceptions\\NotFoundHttpException' => SYS_PATH.'classes/Core/Exceptions/NotFoundHttpException.php',
    'Syscode\\Core\\Exceptions\\PreconditionFailedHttpException' => SYS_PATH.'classes/Core/Exceptions/PreconditionFailedHttpException.php',
    'Syscode\\Core\\Exceptions\\PreconditionRequiredHttpException' => SYS_PATH.'classes/Core/Exceptions/PreconditionRequiredHttpException.php',
    'Syscode\\Core\\Exceptions\\ServerErrorHttpException' => SYS_PATH.'classes/Core/Exceptions/ServerErrorHttpException.php',
    'Syscode\\Core\\Exceptions\\ServiceUnavailableHttpException' => SYS_PATH.'classes/Core/Exceptions/ServiceUnavailableHttpException.php',
    'Syscode\\Core\\Exceptions\\UnauthorizedHttpException' => SYS_PATH.'classes/Core/Exceptions/UnauthorizedHttpException.php',
    'Syscode\\Core\\Exceptions\\UnprocessableEntityHttpException' => SYS_PATH.'classes/Core/Exceptions/UnprocessableEntityHttpException.php',
    'Syscode\\Core\\Exceptions\\UnsupportedMediaTypeHttpException' => SYS_PATH.'classes/Core/Exceptions/UnsupportedMediaTypeHttpException.php',
    ...
    'Syscode\\Debug\\Engine\\Collection' => SYS_PATH.'classes/Debug/Engine/Collection.php',
    'Syscode\\Debug\\Engine\\Formatter' => SYS_PATH.'classes/Debug/Engine/Formatter.php',
    'Syscode\\Debug\\Engine\\Frame' => SYS_PATH.'classes/Debug/Engine/Frame.php',
    'Syscode\\Debug\\Engine\\Supervisor' => SYS_PATH.'classes/Debug/Engine/Supervisor.php',
