        ...
        <div class="wrapper">
			...
			<div class="container">
				...
				<div class="info">
					...
					<h1><small>Welcome to</small><span>{{ config('app.name').' '.version() }}</span></h1>
					<div class="status">
						<code>
							<span class="check">
