 ...
 * @method tomorrow(string $timezone = null)
 * @method createFromDate(int $year = null, int $month = null, int $day = null, string $timezone = null)
 * @method createFromTime(int $hour = null, int $minutes = null, int $seconds = null, string $timezone = null)
 * @method create(int $year = null, int $month = null, int $day = null, int $hour = null, int $minutes = null, int $seconds = null, string $timezone = null)
 * @method createFromFormat(string $format, string $datetime, \DateTimeZone|string $timezone = null)
 * @method createFromTimestamp(int $timestamp, string $timezone = null)
 * @method instance(\DateTime $datetime)
 * @method setTestNow(\Syscodes\Components\Support\Chronos\Chronos|string $datetime = null, string $timezone = null)
