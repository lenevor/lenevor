...
/**
 * Allows is register aggregate service providers use to manage console.
 */
class ConsoleServiceProvider extends AggregateServiceProvider implements Deferrable
{
    /**
