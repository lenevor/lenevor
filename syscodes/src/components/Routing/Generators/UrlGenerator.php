...
class UrlGenerator implements UrlGeneratorContract
{
    ...
    public function to($path, $options = [], $secure = null): string
    {
        ...
        // into a single string delimited by slashes.
     ...
     */
    public function route($name, $parameters = [], $forced = true): string
    {
        ...
        if ( ! is_null($this->missingNamedRouteResolver) &&
            ! is_null($url = call_user_func($this->missingNamedRouteResolver, $name, $parameters, $forced))) {
            return $url;
        }
