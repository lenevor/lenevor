...
namespace Syscodes\Components\ThrottleLimiter\throttleLimiting;

/**
 * Allows throttle limit.
 */
class Limit
{
    /**
     * The throttle limit signature key.
     *
     * @var mixed
     */
    public $key;
    ...
    /**
     * The number of seconds until the throttle limit is reset.
     *
     * @var int
     */
    public $decaySeconds;
    ...
    /**
     * Create a new throttle limit using minutes as decay time.
     *
     * @param  int  $decayMinutes
     * @param  int  $maxAttempts
     * 
    ...
    /**
     * Create a new throttle limit using hours as decay time.
     *
     * @param  int  $maxAttempts
    ...
    /**
     * Create a new throttle limit using days as decay time.
     *
     * @param  int  $maxAttempts
     * @param  int  $decayDays
     * 
    ...
    /**
     * Create a new unlimited throttle limit.
     *
     * @return static
     */
    ...
    /**
     * Set the key of the throttle limit.
     *
     * @param  mixed  $key
     * 
     * @return static
