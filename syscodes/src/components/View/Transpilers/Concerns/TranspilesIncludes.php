...
trait TranspilesIncludes
{
    ...
    protected function transpileInclude($expression): string
    {
        ...
        return "<?php echo \$__env->make({$expression}, \Syscodes\Components\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>";
    }
    ...
    protected function transpileIncludeIf($expression): string
    {
        ...
        return "<?php if (\$__env->viewExists({$expression})) echo \$__env->make({$expression}, \Syscodes\Components\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>";
    }
}