                ...
                <a href="#exceptions">
                    <svg width="33px" height="33px" viewBox="-7.3 0 53 53" xmlns="http://www.w3.org/2000/svg">
                        <g id="Group_132" data-name="Group 132" transform="translate(-380.703 -318.103)">
                            ...
                            <path id="Path_479" data-name="Path 479" d="M415.106,361.119h6.7v-39.73a1.99,1.99,0,0,0-1.99-1.99H383.99a1.99,1.99,0,0,0-1.991,1.99v46.428a1.99,1.99,0,0,0,1.991,1.99h29.126v-6.7A1.989,1.989,0,0,1,415.106,361.119Z" fill="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.592"/>
                            <line id="Line_80" data-name="Line 80" x2="17.213" transform="translate(389.184 329.898)" fill="#fff" stroke-miterlimit="10" stroke-width="2.592"/>
                            <line id="Line_81" data-name="Line 81" x2="17.213" transform="translate(389.184 337.063)" fill="#fff" stroke-miterlimit="10" stroke-width="2.592"/>
                            <g id="Group_130" data-name="Group 130">
                                <line id="Line_82" data-name="Line 82" x2="17.213" transform="translate(389.184 344.231)" fill="#fff" stroke-miterlimit="10" stroke-width="2.592"/>
                            </g>
                            ...
                            <path id="Path_482" data-name="Path 482" d="M414.62,327.652,411.272,331l-1.7-1.7" fill="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.555"/>
                            <path id="Path_483" data-name="Path 483" d="M414.62,335l-3.348,3.349-1.7-1.7" fill="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.555"/>
                            <path id="Path_484" data-name="Path 484" d="M414.62,342.345l-3.348,3.349-1.7-1.7" fill="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.555"/>
                            <g id="Group_131" data-name="Group 131">
                            <line id="Line_83" data-name="Line 83" x2="17.213" transform="translate(389.184 351.282)" fill="#fff" stroke-miterlimit="10" stroke-width="2.592"/>
                            </g>
                            <path id="Path_485" data-name="Path 485" d="M414.62,349.4l-3.348,3.349-1.7-1.7" fill="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.555"/>
                        </g>
                    </svg>
                    Exceptions
                </a>
