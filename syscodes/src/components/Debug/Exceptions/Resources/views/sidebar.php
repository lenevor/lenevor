<div class="sidebar">
    <div class="brand">
        <svg viewBox="0 0 233 231" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <ellipse rx="10.325" ry="15" transform="matrix(0.999999 0.00156586 -0.00234002 0.999997 102.104 97.4144)" fill="hsla(255, 100%, 98%, 1)"/>
            <ellipse rx="10.323" ry="14.9991" transform="matrix(0.999982 -0.00594406 0.00675996 0.999977 62.4999 97.5972)" fill="hsla(255, 100%, 98%, 1)"/>
            <defs>
