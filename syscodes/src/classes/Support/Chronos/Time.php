 ...
 * @method int addHours(int $hours)
 * @method int addMinutes(int $minutes)
 * @method int addSeconds(int $seconds)
 * @method int addYears(int $years)
 * @method int addMonths(int $months)
 * @method int addDays(int $days)
 * @method int subHours(int $hours)
 * @method int subMinutes(int $minutes)
 * @method int subSeconds(int $seconds)
 * @method int subYears(int $years)
 * @method int subMonths(int $months)
 * @method int subDays(int $days)
